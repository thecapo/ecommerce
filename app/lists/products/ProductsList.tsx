...
import { IProduct } from "@/app/schemas/productSchema";

export default function ProductsList({ products, initialCartProducts = [] }: { products: IProduct[], initialCartProducts: IProduct[] }) {
